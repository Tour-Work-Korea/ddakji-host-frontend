...
import styles from './ReservationManagement.styles';
...
const ReservationManagement = ({guesthouseId}) => {
  ...
  const buildReservationSearchParams = useCallback(
    (page = DEFAULT_PAGE) => ({
      guesthouseId,
  ...
  const loadNextPage = useCallback(() => {
    if (isReservationsLoading || isLoadingMore || !hasNextPage || !guesthouseId) {
      return;
    }
        ...
        <View style={styles.searchBox}>
          <View style={styles.searchFilterContainer}>
            <TouchableOpacity
              ...
              <Text style={[FONTS.fs_14_regular]}>{selectedSearchFilter}</Text>
              {isSearchFilterOpen ? (
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[
                        FONTS.fs_14_regular,
                        styles.searchFilterOptionText,
                        selectedReservationStatus === option && {
                          color: COLORS.primary_orange,
                        },
                      ]}>
                      {option}
